...
- **reviewer-001 (name the License+Compliance reviewer — blocking role)**
  ...
  - [ ] Empty-seat fallback recorded: no dataset advances past `pending`, M0 cannot exit, maintainer
        escalates to Elyos governance to source a reviewer.
...
```json
{
  ...
  "acceptanceCriteria": [
    ...
    "dbGaP, EGA, individual-level biobanks, and any identifiable patient data are hard-REJECT and flagged per Elyos refusal guardrails.",
  ...
  "resources": [
    "C:\\code\\elyos\\planning\\projects\\proteomics-reanalysis\\PLAN.md",
...
> Auto-generated by Elyos task decomposition on 2026-06-29. All 26 tasks validated against the
> Elyos Task JSON schema (draft-07, additionalProperties:false). Seed file (allowlist-002) retained
